# Readpath (the `fabricator/` code)

Older variant: predictive prefetch (V1). The delegated-research threat model that builds on it is in the [top-level README](../README.md). Run everything from inside this folder.
